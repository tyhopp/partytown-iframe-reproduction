/* Partytown 0.6.1 - MIT builder.io */
(self => {
    ...
    const getPartytownScript = () => `<script src="${partytownLibUrl("partytown.js?v=0.6.1")}"><\/script>`;
                    ...
                    if (!hasInitializedMedia) {
                        (() => {
                            if (!webWorkerCtx.$initWindowMedia$) {
                                ...
                                webWorkerCtx.$importScripts$(partytownLibUrl("partytown-media.js?v=0.6.1"));
